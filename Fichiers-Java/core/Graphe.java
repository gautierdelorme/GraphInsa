...
public class Graphe {
	...
	try {
	    ...
	    // Nombre de descripteurs enregistr̩s dans le fichier.
    ...
    public void perso() {
        ...
        float NbMoySucc = 0;
        for (Noeud n : noeuds) {
            NbMoySucc += n.getNbSuccesseurs();
        }
        NbMoySucc /= Noeud.nbNoeuds;
        System.out.println("Nombre moyen de successeurs :"+NbMoySucc);    
    }
     ...
     *  Verifie que le chemin efloatst empruntable et calcule le temps de trajet.
     */
